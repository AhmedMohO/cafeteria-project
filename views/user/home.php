...
$selectedRoomId = isset($selectedRoomId) ? (int) $selectedRoomId : 0;
$selectedRoomText = isset($selectedRoomText) ? (string) $selectedRoomText : '';
...
$url = static function (string $path) use ($runtimeBase): string {
...
window.CAFETERIA_ENDPOINTS = {
    searchProducts: <?= json_encode($url('/user/search-products')) ?>,
    latestOrder: <?= json_encode($url('/user/latest-order')) ?>,
    placeOrder: <?= json_encode($url('/user/place-order')) ?>,
    uploadsBase: <?= json_encode($url('/uploads')) ?>
};
</script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="<?= htmlspecialchars($url('/js/main.js')) ?>"></script>
</body>
</html>
