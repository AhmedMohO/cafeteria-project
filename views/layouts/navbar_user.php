...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
  <div class="container">
    <a class="navbar-brand fw-bold text-warning fs-5" href="<?= BASE_URL ?>/index.php">
    ...
    <div class="collapse navbar-collapse" id="navUser">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link <?= $current==='/cafeteria'?'active fw-semibold':'' ?>" href="<?= BASE_URL ?>/cafeteria">
            <i class="bi bi-house me-1"></i>Home
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= $current==='my_orders.php'?'active fw-semibold':'' ?>" href="<?= BASE_URL ?>/user/my_orders">
